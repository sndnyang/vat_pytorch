...
def get_cost_type_semi(model, x, t, ul_x, args):
    if args['--cost_type'] == 'MLE':
        ...
        cost = costs.virtual_adversarial_training_finite_diff(x, t, model.forward_train,
                                                              ...
                                                              x_for_generating_adversarial_examples=ul_x,
                                                              forward_func_for_generating_adversarial_examples=model.forward_no_update_batch_stat)
    elif args['--cost_type'] == 'VAT_rev':
        cost = costs.virtual_adversarial_training_rev(x, t, model.forward_train,
                                                      'CE',
                                                      xi=1e-6,
                                                      epsilon=float(args['--epsilon']),
                                                      norm_constraint=args['--norm_constraint'],
                                                      ...
                                                      x_for_generating_adversarial_examples=ul_x,
                                                      forward_func_for_generating_adversarial_examples=model.forward_no_update_batch_stat)
    elif args['--cost_type'] == 'VAT_d':
        cost = costs.virtual_adversarial_training_double(x, t, model.forward_train,
                                                         'CE',
                                                         epsilon=float(args['--epsilon']),
                                                         ...
                                                         x_for_generating_adversarial_examples=ul_x,
                                                         forward_func_for_generating_adversarial_examples=model.forward_no_update_batch_stat)
    elif args['--cost_type'] == 'VAT_rev_d':
        cost = costs.virtual_adversarial_training_rev_double(x, t, model.forward_train,
                                                             'CE',
                                                             epsilon=float(args['--epsilon']),
                                                             eps_n=float(args['--eps_w']),
                                                             lamb=float(args['--lamb']),
                                                             ...
                                                             x_for_generating_adversarial_examples=ul_x,
                                                             forward_func_for_generating_adversarial_examples=model.forward_no_update_batch_stat)
    elif args['--cost_type'] == 'VAT_s':
        cost = costs.virtual_adversarial_training_sharp(x, t, model.forward_train,
                                                        'CE',
                                                        epsilon=float(args['--epsilon']),
                                                        eps_n=float(args['--eps_w']),
                                                        lamb=float(args['--lamb']),
        ...
        cost = costs.virtual_adversarial_training_noise(x, t, model.forward_train,
                                                        ...
                                                        x_for_generating_adversarial_examples=ul_x,
                                                        forward_func_for_generating_adversarial_examples=model.forward_no_update_batch_stat)
    elif args['--cost_type'] == 'VAT_mm':
        cost = costs.virtual_adversarial_training_max_min(x, t, model.forward_train,
                                                          'CE',
                                                          epsilon=float(args['--epsilon']),
                                                          ...
                                                          x_for_generating_adversarial_examples=ul_x,
                                                          forward_func_for_generating_adversarial_examples=model.forward_no_update_batch_stat)
    elif args['--cost_type'] == 'VAT_p':
        cost = costs.virtual_adversarial_training_plus(x, t, model.forward_train,
                                                       'CE',
                                                       epsilon=float(args['--epsilon']),
                                                       norm_constraint=args['--norm_constraint'],
                                                       num_power_iter=int(args['--num_power_iter']),
                                                       x_for_generating_adversarial_examples=ul_x,
                                                       forward_func_for_generating_adversarial_examples=model.forward_no_update_batch_stat)
    elif args['--cost_type'] == 'VAT_pp':
        cost = costs.virtual_adversarial_training_plus_plus(x, t, model.forward_train,
                                                            'CE',
                                                            epsilon=float(args['--epsilon']),
                                                            n_eps_c=float(args['--n_eps_c']),
                                                            neg_lamb=float(args['--neg_lamb']),
                                                            norm_constraint=args['--norm_constraint'],
                                                            num_power_iter=int(args['--num_power_iter']),
                                                            x_for_generating_adversarial_examples=ul_x,
